...
sleep(2)
login_button = driver.find_element(by=By.XPATH, value='//*[@id="content"]/div/div[1]/div/main/div['
                                                      '1]/div/div/header/div[1]/div[ '
                                                      '2]/div/button')
login_button.click()
...
sleep(5)
allow_location_button = driver.find_element(by=By.XPATH, value='//*[@id="modal-manager"]/div/div/div/div/div['
                                                               '3]/button[1]')
allow_location_button.click()
notifications_button = driver.find_element(by=By.XPATH, value='//*[@id="modal-manager"]/div/div/div/div/div['
                                                              '3]/button[2]')
...
for n in range(100):
    ...
    try:
        print("called")
        like_button = driver.find_element(by=By.XPATH, value='//*[@id="content"]/div/div[1]/div/main/div['
