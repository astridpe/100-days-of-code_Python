...
#
# total_articles = driver.find_element(by=By.XPATH, value="/html/body/div[3]/div[3]/div[5]/div[1]/div[1]/div/div[
# 3]/a[1]") # print(total_articles.text)
#
# view_source = driver.find_element(by=By.LINK_TEXT, value="View source")
# # view_source.click()
#
...
# Challenge - Fill out form using Selenium:
driver.get("http://secure-retreat-92358.herokuapp.com/")
fname = driver.find_element(by=By.NAME, value="fName")
fname.send_keys("Astrid")

lname = driver.find_element(by=By.NAME, value="lName")
lname.send_keys("Pettersen")

email = driver.find_element(by=By.NAME, value="email")
email.send_keys("astridtesting282@gmail.com")
